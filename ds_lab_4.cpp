...
{   doubly_LL l1;
	...
	int num;
		...
		cout<<"Enter 1 for insert element at beg"<<endl<<"Enter 2 for insert at end"<<endl<<"Enter 3 for display"<<endl<<"Enter 4 for insert after"<<endl<<"Enter 5 for exit"<<endl<<"Enter 6 for insert before"<<endl<<"Enter 7 for delete a node"<<endl<<"Enter 8 for search an element"<<endl;
        cin>>num;
	while(num!=5)
	{
	if(num==1)
